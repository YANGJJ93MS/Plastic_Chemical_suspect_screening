...
# import positive data
  ...
  # data <- read_tsv(file_path2, col_names = FALSE, col_types = cols(.default = "c"), skip_empty_rows = FALSE)
  data <- read_tsv(file_path, col_names = FALSE, col_types = cols(.default="c"), skip_empty_rows = FALSE)
  ...
  write.csv(file = "D:/UCSF_postdoc_topic/REVEAL_topics/REVEAL_200samples_analysis/Neg_AlignmentResults/filtered_peak_area_for_bc.csv", result_df)
  ...
  ggsave(p_before, file = 'D:/UCSF_postdoc_topic/REVEAL_topics/REVEAL_200samples_analysis/Neg_AlignmentResults/PCA_before_batchcorr.tiff',
         dpi=300, height = 8, width=10)
  ...
  #        dpi=300, height = 8, width=10)
  ggsave(p_after, file = 'D:/UCSF_postdoc_topic/REVEAL_topics/REVEAL_200samples_analysis/Neg_AlignmentResults/PCA_after_batchcorr.tiff',
         dpi=300, height = 8, width=10)
  ...
  write.csv(file = "D:/UCSF_postdoc_topic/REVEAL_topics/REVEAL_200samples_analysis/Neg_AlignmentResults/filtered_peak_area_after_bc.csv", result_df2)
  save.image(file = 'D:/UCSF_postdoc_topic/REVEAL_topics/REVEAL_200samples_analysis/Neg_AlignmentResults/neg_data_processing.RData')
  
  #Log transformation, correlation heatmap among features, or molecular network
  #

  
  #20241117 import sample demographic data
  #
